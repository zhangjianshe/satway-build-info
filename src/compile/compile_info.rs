...
impl CompileInfo {
    ...
    pub fn load_from_env() -> Self {
        ...
        let git_log =
            String::from_utf8(output.stdout).expect("Failed to convert git log output to string");
        ...
        let rustc_cmd = Command::new("rustc")
            .args(&["--version"])
            .output()
            .expect("Failed to execute rustc");
        let rustc_output =
            String::from_utf8(rustc_cmd.stdout).expect("Failed to convert rustc output to string");
